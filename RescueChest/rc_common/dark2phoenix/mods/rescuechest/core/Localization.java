...
public class Localization {
     ...
     *            The default localization to be used when there is no
     *            localization for the selected language or if a string is
     *            missing (e.g. "en_US")
     */
    ...
    private static String getCurrentLanguage() {
        return RescueChest.proxy.getCurrentLanguage();
    }
}